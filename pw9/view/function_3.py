...
# from pw9.model.old_db.mark import Mark
...
class Function3(Frame):
    ...
    def command_button_enter(self):
        #
        if db_sql.check_s_id(self.et_st_id.get()):
    ...
    def command_button_enter_2(self):
        if db_sql.check_s_id(self.et_st_id.get()):
            ...
            self.set_st_gpa(self.et_st_id.get())
        else:
            self.cbb_destroy()
    ...
    def set_st_gpa(self, sid):
        db_sql.set_st_gpa(sid)
    ...
    def combobox_and_mark(self):
        # combo box
        id_name_cour_list = db_sql.get_id_name_cour_list()
