...
class Function5(Frame):
    ...
    def command_bt_id_up(self):
        db_sql.sort_cour_list_by_id_up()
        self.destroy_inf()
        self.show_inf()
    ...
    def command_bt_id_down(self):
        db_sql.sort_cour_list_by_id_down()
        self.destroy_inf()
        self.show_inf()
        self.button_id.config(text="Courses ID  ↑",
    ...
    def command_bt_name_up(self):
        db_sql.sort_cour_list_by_name_up()
        self.destroy_inf()
        self.show_inf()
    ...
    def command_bt_name_down(self):
        db_sql.sort_cour_list_by_name_down()
        self.destroy_inf()
        self.show_inf()
        self.button_name.config(text="Courses Name  ↑",
    ...
    def show_inf(self):
        ...
        #
        for i in db_sql.get_all_courses_inf():
            #
            c_id = i[0]
            c_name = i[1]
            #
